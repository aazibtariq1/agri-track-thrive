     ...
     try {
       ...
       if (isEditing) {
         ...
         toast({
           ...
           description: `PKR ${formData.amount} income updated.`,
         });
       } else {
       ...
       toast({
         title: isEditing ? "Error updating income" : "Error adding income",
         description: getUserFriendlyError(error),
         variant: "destructive",
       });
     }
                         ...
                         <AlertDialog>
                           ...
                           <AlertDialogContent>
                             ...
                             <AlertDialogFooter>
                               ...
                               <AlertDialogAction onClick={() => handleDelete(inc.id)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                                 Delete
                               </AlertDialogAction>
                             </AlertDialogFooter>
                           </AlertDialogContent>
